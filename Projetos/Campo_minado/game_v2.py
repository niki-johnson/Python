import random
import settings_game_v2 as settings
import utils
from tkinter import *

root = Tk()
# mudando o tamanho da janela root.geometry('WIDTHxHEIGHT')
root.geometry(f'{settings.WIDTH}x{settings.HEIGHT}')

# impedindo que ocorra o redimensionamento da tela
...
# criando frames
top_frame = Frame(
    root,  # onde esta localizado o frame
    bg='black',
    width=settings.WIDTH,
    height=utils.prct_height(25)
).place(x=0, y=0)  # definindo onde vamos inicar o frame - a tela vira um plano cartesiano

left_frame = Frame(
    root,
    bg='black',
    width=utils.prct_width(25),
    height=utils.prct_height(75)
).place(x=0, y=180)

center_frame = Frame(
    root,
    bg='black',
    width=utils.prct_width(75),
    height=utils.prct_height(75)
).place(x=utils.prct_width(25), y=utils.prct_height(25))
