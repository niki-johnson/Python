"""
    ...
    Aolica-se novo conceito -> sobrecarga de operador
    Utiliza metodo __iadd__ para add tarefas de maneira mais fácil
...
def main():
    ...
    casa.procurar('Trocar').concluir()  # add automaticamente quando conclui
    print(casa)
