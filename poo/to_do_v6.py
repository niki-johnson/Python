"""
    ...
    Aplica-se um novo conceito: métodos 'privados'
    A depender se a descricao da tarefa é insanciada ou n, é chamado 2 metodos privados
...
def main():
    ...
    casa.add(TarefaRecorrente('Trocar lençóis', datetime.now()))
